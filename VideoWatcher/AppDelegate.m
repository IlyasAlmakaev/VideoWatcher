...
{
    WatcherTableViewController *watcherTableViewController = [[WatcherTableViewController alloc]  init];
    
    AppDelegate *appDelegate = [UIApplication sharedApplication].delegate;
    watcherTableViewController.managedObjectContext = appDelegate.managedObjectContext;
    
    return watcherTableViewController.managedObjectContext;
}
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "good.VideoWatcher" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"VideoWatcher" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"VideoWatcher.sqlite"];
    NSError *error = nil;
